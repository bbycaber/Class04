...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { name: @grade.name, score: @grade.score, student_id: @grade.student_id, subject_id: @grade.subject_id }
    end
  ...
  test "should update grade" do
    patch :update, id: @grade, grade: { name: @grade.name, score: @grade.score, student_id: @grade.student_id, subject_id: @grade.subject_id }
    assert_redirected_to grade_path(assigns(:grade))
  end
